...
public class FacilityManagerRestController {
	...
	@RequestMapping("isMeetingRoomAvailable/{requestId}")
	@GetMapping
	public Boolean isMeetingRoomAvailable(@PathVariable("requestId") String requestId){
		MeetingRequest pendingRequest = new MeetingRequest();
		pendingRequest.setRequestId(requestId);
		return facilityManagerService.isMeetinRoomAvailable(pendingRequest);
	}
	...
	@PutMapping
	public void acceptRequest(@RequestBody MeetingRequest request) {

		facilityManagerService.acceptRequest(request.getRequestId());
	}
	@RequestMapping("acceptHRRequest")
	@PutMapping
	public void acceptHRRequest(@RequestBody MeetingRequest request) {
		facilityManagerService.acceptHRRequest(request.getRequestId());
	}
